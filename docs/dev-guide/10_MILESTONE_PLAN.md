...
- UI §18.4 移动 27 页达成 **22/27**：缺口 5 页均有登记偏差——HOME-02/CHAT-02 卡后端 `advice_records` 查询 API 未开放（P2，另立后端工作项），ONB-01/SET-05/07 维持 P2 裁剪线。
- 基准卡 8→**19 张**（11 张 V4 新页追溯卡于批次审计日补齐）。
